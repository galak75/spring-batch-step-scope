...
public class SingletonScopedCompositeItemProcessorTest {
    ...
    static class TestConfig {
        ...
        @Bean
        public ItemProcessor<String, String> compositeProcessor() {
	    		CompositeItemProcessor<String, String> cip = new CompositeItemProcessor<String, String>();
	    		List<ItemProcessor<String, String>> itemProcessors = new ArrayList<ItemProcessor<String, String>>();
